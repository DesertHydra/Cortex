...
public class CortexModelProvider extends FabricModelProvider {
	...
	public void generateBlockStateModels(BlockStateModelGenerator generator) {
		...
		generator.registerSimpleCubeAll(CortexBlocks.SUSPICIOUS_SOUL_SAND);
		generator.registerSimpleCubeAll(CortexBlocks.SUSPICIOUS_SOUL_SOIL);
	}
	...
	public void generateItemModels(ItemModelGenerator generator) {
		...
		generator.register(CortexItems.SMELTED_DEBRIS, Models.SINGLE_LAYER_ITEM);
	}
}
